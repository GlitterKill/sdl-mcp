...
- **Release workflow surfaces**: Tracked required Codex/Claude SessionStart and SDL Explorer agent files so CI docs workflow checks use the same surfaces as local release gates.

_29 commits from 2 contributors_
