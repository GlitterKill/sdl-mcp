...
- **Background integrity scan performance**: Increased the bounded read-only symbol page and stopped after a short final page, avoiding repeated ordered LadybugDB traversals while preserving deterministic paging and cooperative cancellation between queries.
