export const SDL_MCP_SERVER_INSTRUCTIONS = [
  ...
  "5. Read and write non-indexed files through `file.read` and `file.write`; edit indexed source through `symbol.edit` for symbol-scoped edits or `searchEditPreview operations[]` for multi-replacement batches.",
