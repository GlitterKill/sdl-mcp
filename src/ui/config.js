...
const FIELD_EFFECTS = Object.freeze({
  ...
  "/indexing/pipeline": "Chooses legacy indexing, guarded provider-first planning, or automatic legacy fallback until provider-first activation is safe.",
  "/indexing/providerFirst/activation": "Targets shadow database activation for provider-first full builds; execution is gated until that handoff is implemented.",
  "/indexing/providerFirst/readyState": "Requires graph data plus derived algorithms before the first provider-first index is ready.",
