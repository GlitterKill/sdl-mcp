...
const FIELD_EFFECTS = Object.freeze({
  ...
  "/indexing/pipeline": "Chooses legacy indexing, provider-first indexing, or automatic provider-first selection when SCIP/LSP coverage is configured.",
  "/indexing/providerFirst/activation": "Uses shadow database activation for provider-first full builds.",
