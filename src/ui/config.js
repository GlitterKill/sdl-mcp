...
const FIELD_EFFECTS = Object.freeze({
  ...
  "/indexing/pipeline": "Chooses legacy indexing, provider-first SCIP execution with same-run legacy fallback for full builds, or automatic legacy fallback when provider execution is unavailable.",
  ...
  "/indexing/providerFirst/maxLegacyFallbackFiles": "Emergency cap for same-run legacy fallback when provider-first coverage leaves a very large uncovered tail.",
  ...
  "/scip/autoIngestOnRefresh": "Deprecated compatibility field; provider-first indexing owns SCIP materialization.",
  "/scip/generator/autoInstall": "Allows SDL-MCP to install the configured SCIP generator when it is missing.",
  "/scip/generator/cleanupAfterIngest": "Deprecated compatibility field; provider-first keeps generated SCIP artifacts under generator/cache ownership.",
