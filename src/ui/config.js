...
const FIELD_EFFECTS = Object.freeze({
  ...
  "/indexing/pipeline": "Chooses legacy indexing, provider-first SCIP execution for fully covered full builds, or automatic legacy fallback when provider execution is incomplete.",
