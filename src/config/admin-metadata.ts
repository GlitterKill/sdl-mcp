...
export const CONFIG_UI_SECTIONS: ConfigUiSectionMeta[] = [
  ...
  { id: "semanticEnrichment", label: "Semantic Enrichment", path: "/semanticEnrichment", description: "Provider source selection diagnostics for SCIP and LSP.", docsAnchor: "semantic-enrichment" },
  { id: "scip", label: "SCIP", path: "/scip", description: "Provider-first SCIP inputs, external symbols, and scip-io generation.", docsAnchor: "scip" },
