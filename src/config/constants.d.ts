 ...
 */
export declare const DB_CHUNK_SIZE = 500;
/**
 * Default limit for database query results.
 */
export declare const DB_QUERY_LIMIT_DEFAULT = 50;
/**
 * Maximum limit for database query results.
 */
export declare const DB_QUERY_LIMIT_MAX = 100;
/**
 * Default maximum number of lines to return in hot path excerpts.
 */
export declare const DEFAULT_MAX_LINES_HOTPATH = 50;
/**
 * Default maximum token budget for hot path excerpts.
 */
export declare const DEFAULT_MAX_TOKENS_HOTPATH = 1000;
/**
 * Default maximum number of lines to return in code skeletons.
 */
export declare const DEFAULT_MAX_LINES_SKELETON = 100;
/**
 * Default maximum token budget for code skeletons.
 */
export declare const DEFAULT_MAX_TOKENS_SKELETON = 2000;
/**
 * Maximum lines for detailed code skeletons.
 */
export declare const DEFAULT_MAX_LINES_SKELETON_DETAILED = 200;
/**
 * Maximum token budget for detailed code skeletons.
 */
export declare const DEFAULT_MAX_TOKENS_SKELETON_DETAILED = 5000;
/**
 ...
 */
export declare const SYMBOL_SEARCH_DEFAULT_LIMIT = 50;
/**
 * Priority weight for window size limit policy (highest).
 */
export declare const POLICY_PRIORITY_WINDOW_SIZE_LIMIT = 100;
/**
 * Priority weight for identifier requirement policy.
 */
export declare const POLICY_PRIORITY_IDENTIFIERS_REQUIRED = 90;
/**
 * Priority weight for budget enforcement policy.
 */
export declare const POLICY_PRIORITY_BUDGET_CAPS = 80;
/**
 * Priority weight for break-glass override policy (lowest).
 */
export declare const POLICY_PRIORITY_BREAK_GLASS = 10;
/**
 * Priority weight for default deny raw code policy.
 */
export declare const POLICY_PRIORITY_DEFAULT_DENY_RAW = 5;
/**
 * Minimum Node.js major version required.
 */
export declare const NODE_MIN_MAJOR_VERSION = 18;
/**
 ...
 */
export declare const DEFAULT_INDEXING_CONCURRENCY = 8;
/**
 * Maximum concurrency level for indexing operations.
 */
export declare const MAX_INDEXING_CONCURRENCY = 10;
/**
 * Default timeout for operations in milliseconds.
 */
export declare const DEFAULT_OPERATION_TIMEOUT_MS = 2000;
/**
 * Minimum operation timeout in milliseconds.
 */
export declare const MIN_OPERATION_TIMEOUT_MS = 100;
/**
 * Minimum length for AWS Access Key ID in regex pattern.
 */
export declare const AWS_KEY_MIN_LENGTH = 16;
/**
 * Maximum length for AWS Access Key ID in regex pattern.
 */
export declare const AWS_KEY_MAX_LENGTH = 32;
/**
 * Length of GitHub personal access token in regex pattern.
 */
export declare const GITHUB_TOKEN_LENGTH = 36;
/**
 * Stability score contribution for stable interface.
 */
export declare const STABILITY_SCORE_INTERFACE = 33;
/**
 * Stability score contribution for stable behavior.
 */
export declare const STABILITY_SCORE_BEHAVIOR = 33;
/**
 * Stability score contribution for stable side effects.
 */
export declare const STABILITY_SCORE_SIDE_EFFECTS = 34;
/**
 * Default maximum number of symbol card entries in cache.
 */
export declare const DEFAULT_SYMBOL_CARD_CACHE_MAX_ENTRIES = 2000;
/**
 * Default maximum size of symbol card cache in bytes (100MB).
 */
export declare const DEFAULT_SYMBOL_CARD_CACHE_MAX_SIZE_BYTES: number;
/**
 * Default maximum number of graph slice entries in cache.
 */
export declare const DEFAULT_GRAPH_SLICE_CACHE_MAX_ENTRIES = 1000;
/**
 * Default maximum size of graph slice cache in bytes (50MB).
 */
export declare const DEFAULT_GRAPH_SLICE_CACHE_MAX_SIZE_BYTES: number;
