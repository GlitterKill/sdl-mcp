...
export function createActionHandlerMap(
  ...
  return {
    ...
    "symbol.edit": (args, ctx) => handleSymbolEdit(args, ctx, liveIndex),
    ...
    "file.write": (args, ctx) => handleFileWrite(args, ctx, liveIndex),
    "search.edit": (args, ctx) => handleSearchEdit(args, ctx, liveIndex),
