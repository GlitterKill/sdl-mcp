...
import {
  ...
  collectCallProofCoverageSamples,
  collectCallProofMismatchSamples,
  mergeCallProofSamples,
} from "./provider-first/call-proof-samples.js";
import {
...
/** @internal Compatibility export for existing diagnostic consumers and tests. */
export { collectCallProofMismatchSamples } from "./provider-first/call-proof-samples.js";
