...
export interface LanguageAdapter {
    ...
    extractImports(tree: Tree, content: string, filePath: string): ExtractedImport[];
    extractCalls(tree: Tree, content: string, filePath: string, extractedSymbols: ExtractedSymbol[]): ExtractedCall[];
}
