...
describe("Grammar Loading Integration Tests (ML-B.1, ML-B.3)", () => {
    describe("Python Grammar", () => {
        it("should load tree-sitter-python grammar", () => {
            ...
            assert.strictEqual(tree.rootNode.type, "module", "Root node should be module");
        });
...
`.trim();
            ...
            assert.strictEqual(tree.rootNode.hasError, false, "Should parse without errors");
        });
    });
    describe("Go Grammar", () => {
...
`.trim();
    ...
    describe("Java Grammar", () => {
        it("should load tree-sitter-java grammar", () => {
            ...
            const sourceCode = 'public class HelloWorld {\n    public static void main(String[] args) {\n        System.out.println("Hello, World!");\n    }\n}\n';
            const tree = parser.parse(sourceCode);
            assert.ok(tree, "Should parse Java code");
            assert.ok(tree.rootNode, "Should have root node");
            assert.strictEqual(tree.rootNode.type, "program", "Root node should be program");
        });
...
`.trim();
    ...
    describe("C# Grammar", () => {
        it("should load tree-sitter-c-sharp grammar", () => {
            ...
            assert.ok(tree.rootNode, "Should have root node");
            assert.strictEqual(tree.rootNode.type, "compilation_unit", "Root node should be compilation_unit");
        });
...
`.trim();
    ...
    describe("C Grammar", () => {
        it("should load tree-sitter-c grammar", () => {
            ...
            assert.ok(tree, "Should parse C code");
            assert.ok(tree.rootNode, "Should have root node");
            assert.strictEqual(tree.rootNode.type, "translation_unit", "Root node should be translation_unit");
        });
        it("should parse basic C constructs", () => {
            const C = require("tree-sitter-c");
            const Parser = require("tree-sitter");
...
//# sourceMappingURL=grammar-loading.test.js.map