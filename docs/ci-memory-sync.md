...
graph LR
    A[Push to main] e1@--> B[CI Job]
    B e2@--> C[Sync Memory Job]
    C e3@--> D[Export Artifacts]
    D e4@--> E[Upload Artifacts]
    E e5@--> F[Sync Validation Job]
    F e6@--> G[Compare Artifacts]
    G e7@--> H[Validate Performance]
