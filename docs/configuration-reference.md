...
| `providerFirst.maxLegacyFallbackFiles`      | `number`                                | `5000`                                     | Maximum uncovered or provider-unusable files parsed by same-run legacy fallback after provider-first materialization. When the gap is larger, SDL-MCP keeps the provider-primary rows, stages and loads a provider-primary shadow, skips the expensive fallback parse, reports the skipped count, and leaves graph-derived readiness plus shadow finalization/activation deferred instead of turning a partial provider artifact into a huge tree-sitter full-repo parse. Set a larger value for repos where completing the legacy fallback is worth the time.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
