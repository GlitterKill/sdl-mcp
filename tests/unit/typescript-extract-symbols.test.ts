...
`.trim();
    ...
    const repoIdSymbol = symbols.find((s: any) => s.name === "RepoId");
    ...
    const symbolIdSymbol = symbols.find((s: any) => s.name === "SymbolId");
    ...
    const edgeTypeSymbol = symbols.find((s: any) => s.name === "EdgeType");
...
`.trim();
    ...
    const repoRowSymbol = symbols.find((s: any) => s.name === "RepoRow");
    ...
    const fileRowSymbol = symbols.find((s: any) => s.name === "FileRow");
...
`.trim();
    ...
    const exportedSymbol = symbols.find((s: any) => s.name === "ExportedType");
    ...
    const internalTypeSymbol = symbols.find(
      (s: any) => s.name === "InternalType",
    );
    ...
    const internalInterfaceSymbol = symbols.find(
      (s: any) => s.name === "InternalInterface",
    );
...
`.trim();
    ...
    const resultSymbol = symbols.find((s: any) => s.name === "Result");
    ...
    const mapSymbol = symbols.find((s: any) => s.name === "Map");
...
`.trim();
    ...
    const entitySymbol = symbols.find((s: any) => s.name === "Entity");
    ...
    const userSymbol = symbols.find((s: any) => s.name === "User");
