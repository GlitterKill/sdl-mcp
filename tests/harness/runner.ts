...
// Tools that are always registered in non-gateway, non-code-mode runs.
// Code-mode tools are covered separately in unit tests because they are
...
const CLIENT_PROFILES: ClientProfile[] = [
  {
    ...
    expectedTools: ALWAYS_REGISTERED_TOOLS,
  },
  {
    name: "codex",
